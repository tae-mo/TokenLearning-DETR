...
class PositionEmbeddingSine(nn.Module):
    ...
    def forward(self, tensor_list: NestedTensor):
        ...
        # print(f"stack shape: {torch.stack((pos_x[:, :, :, 0::2].sin(), pos_x[:, :, :, 1::2].cos()), dim=4).shape}")
        # stack 후 flatten 안하면 sin sin sin ... cos cos cos ...이렇게 들어가는데,  
        # dim=4로 stack 후 flatten해서 sin cos sin cos ...이렇게 들어가도록 함
